...
@Service
public class CustomGutendexService {

    private static final String BASE_URL = "https://gnikdroy.pythonanywhere.com/api/v1/books";
    ...
    private List<Book> mapToBooks(List<GutendexBook> gutendexBooks) {
        ...
        for (GutendexBook gutendexBook : gutendexBooks) {
            ...
            for (GutendexAuthor gutendexAuthor : gutendexBook.getAuthors()) {
                ...
                author.setBirthYear(gutendexAuthor.getBirthYear() != 0 ? gutendexAuthor.getBirthYear() : null);
                author.setDeathYear(gutendexAuthor.getDeathYear() != null ? gutendexAuthor.getDeathYear() : null);
                authors.add(author);
            }
